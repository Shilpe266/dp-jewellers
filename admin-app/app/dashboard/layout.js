...
const routePermissions = {
  ...
  '/dashboard/pricing': { roles: ['super_admin', 'admin'], permission: 'manageRates' },
  ...
  '/dashboard/collections': { roles: ['super_admin', 'admin'], permission: 'managePromotions' },
  '/dashboard/approvals': { roles: ['super_admin'] },
